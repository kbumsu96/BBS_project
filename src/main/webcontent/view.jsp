...
<body>
	...
	<div class=" container">
		...
		+ bbs.getBbsDate().substring(14, 16) + "분"%></td>
					...
					<tr>
						<td>내용</td>
						<td colspan="2" style="min-height: 200px; text-aligh: left;"><%=bbs.getBbsContent().replaceAll(" ", "&nbsp").replaceAll("<", "&lt;").replaceAll(">", "&gt;").replaceAll("\n", "<br>")%></td>
					</tr>
				</tbody>
			</table>
			...
			%>
			<a href="update.jsp?bbsID<%=bbsID%>" class="btn btn-primary">수정</a> <a
